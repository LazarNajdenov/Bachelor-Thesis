...
betas = {'beta = 1','beta = 1.1','beta = 1.2', 'beta = 1.3','beta = 1.4'...
    'beta = 1.5', 'beta = 1.6', 'beta = 1.7','beta = 1.8','beta = 1.9','beta = 2'};
...
figure(1);
plot(1:0.1:2, acc,'LineWidth',2,'Marker','o','MarkerFaceColor','red','MarkerSize',10);
xlabel('Beta')
ylabel('Accuracy')
figure(2);
plot(1:0.1:2,cut,'LineWidth',2,'Marker','o','MarkerFaceColor','red','MarkerSize',10);
xlabel('Beta')
ylabel('Normalized Cuts')
figure(3);
plot(1:0.1:2,modul,'LineWidth',2,'Marker','o','MarkerFaceColor','red','MarkerSize',10);
xlabel('Beta')
ylabel('Modularity')